...
(
  ...
  CONSTRAINT grader_config_grader_user_id_fkey FOREIGN KEY (grader_user_id)
...
ALTER TABLE employmeo.grader ADD grader_notes text;
ALTER TABLE employmeo.grader ADD grader_modified_date timestamp with time zone;
...
ALTER TABLE employmeo.grader DROP grader_notes;
ALTER TABLE employmeo.grader DROP grader_modified_date;
