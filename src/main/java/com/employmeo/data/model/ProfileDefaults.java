...
public class ProfileDefaults {
	...
	public static final String aName = "Rising Star";
	public static final String aIcon = "fa-rocket";
	public static final String aClass = "btn-success";
	...
	public static final String bName = "Long Timer";
	public static final String bIcon = "fa-user-plus";
	public static final String bClass = "btn-info";
	...
	public static final String cName = "Churner";
	public static final String cIcon = "fa-warning";
	public static final String cClass = "btn-warning";
	...
	public static final String dName = "Red Flag";
	public static final String dIcon = "fa-hand-stop-o";
	public static final String dClass = "btn-danger";
	...
	public static final CustomProfile DEFAULT_PROFILES = new CustomProfile();
	public static final ScoringScale DEFAULT_SCALE = new ScoringScale();
